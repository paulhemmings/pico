...
import razor.lib.R;
import razor.lib.core.CoreExpandableActivity;
...
public abstract class CoreViewModelExpandableListAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
	...
	protected View SetGroupViewDrawable(View groupView, boolean isExpanded){
		Drawable groupDrawable = null;
		 if (isExpanded) {
			 groupDrawable = groupView.getResources().getDrawable(R.drawable.orange_gradient_background);
		 } else {
			 groupDrawable = groupView.getResources().getDrawable(R.drawable.blue_gradient_background);
		 }		
