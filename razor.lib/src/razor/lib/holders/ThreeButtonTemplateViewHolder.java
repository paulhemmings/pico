...
public class ThreeButtonTemplateViewHolder implements OnClickListener {
	...
	public ThreeButtonTemplateViewHolder(OnThreeButtonTemplateEventListener eventListener,View parentView, Integer backgroundDrawableResourceId){
		...
		this.positiveView = (TextView) parentView.findViewById(razor.lib.R.id.lib_three_button_template_action_positive);
		this.neutralView = (TextView) parentView.findViewById(razor.lib.R.id.lib_three_button_template_action_neutral);
		this.negativeView = (TextView) parentView.findViewById(razor.lib.R.id.lib_three_button_template_action_negative);
	...
	public void onClick(View v) {
		if(this.eventListener!=null){
			if(v.getId()==razor.lib.R.id.lib_three_button_template_action_positive){
				this.positiveView.setEnabled(false);
				this.eventListener.onThreeButtonPositive();
			}
			if(v.getId()==razor.lib.R.id.lib_three_button_template_action_neutral){
				this.neutralView.setEnabled(false);
				this.eventListener.onThreeButtonNeutral();
			}
			if(v.getId()==razor.lib.R.id.lib_three_button_template_action_negative){
